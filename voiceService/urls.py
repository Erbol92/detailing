...
from .views import voice_register, VoiceDetailView, create_update_voice, closing_voice, voice_from_user
...
urlpatterns = [
    ...
    path('voice_from_user/', voice_from_user, name='voice_from_user'),
